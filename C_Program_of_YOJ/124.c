#include<stdio.h>
#include <stdlib.h>
int has_road(int x,int y,int h[50][50],int R,int C);
int main(){
    FILE *file = fopen("error_124_ck1.in", "r");
...
int has_road(int x,int y,int h[50][50],int R,int C){
    int d[4]={10000,10000,10000,10000},d_min=d[0];
    int decision;
    ...
    if(d_min!=10000)return decision;
    else return -1;
}